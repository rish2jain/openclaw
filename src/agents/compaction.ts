...
async function summarizeChunks(params: {
  ...
  // Strip thinking blocks before summarization to prevent corruption when
  // providers reject persisted thinking blocks (e.g. thinkingSignature fields)
  // during compaction round-trips. See #44370, #44436.
