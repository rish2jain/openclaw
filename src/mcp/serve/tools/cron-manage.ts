      ...
      inputSchema: {
        ...
        properties: {
          action: {
            ...
            enum: ["list", "status", "add", "remove", "runs"],
          },
          id: {
            type: "string",
      ...
      switch (action) {
        ...
        case "remove": {
          if (!args.id || typeof args.id !== "string") {
            return {
              content: [{ type: "text", text: "Error: 'id' is required for the 'remove' action." }],
              isError: true,
            };
          }
        ...
        default:
          return {
            content: [
              {
                type: "text",
                text: `Error: Unknown action '${String(action)}'. Use 'list', 'status', 'add', 'remove', or 'runs'.`,
              },
            ],
            isError: true,
          };
